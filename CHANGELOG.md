...
- `[p2p]` Correctly use non-blocking `TrySendEnvelope` method when attempting to
  ...
  ([tendermint/tendermint\#9936](https://github.com/KYVENetwork/celestia-core/pull/9936))
...
- `[rpc]` Add `match_event` query parameter to indicate to the RPC that it
  ...
  ([tendermint/tendermint\#9759](https://github.com/KYVENetwork/celestia-core/pull/9759))
...
- `[consensus]` Add `consensus_block_gossip_parts_received` and
  ...
  ([tendermint/tendermint\#9733](https://github.com/KYVENetwork/celestia-core/pull/9733))
...
- `[p2p]` Reduce log spam through reducing log level of "Dialing peer" and
  ...
  ([tendermint/tendermint\#9764](https://github.com/KYVENetwork/celestia-core/pull/9764):
  @faddat)
