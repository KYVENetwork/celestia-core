...
import (
	fmt "fmt"
	bits "github.com/KYVENetwork/celestia-core/proto/tendermint/libs/bits"
	types "github.com/KYVENetwork/celestia-core/proto/tendermint/types"
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
