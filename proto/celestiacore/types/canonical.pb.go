...
// source: celestiacore/types/canonical.proto
...
func (*CanonicalBlockID) Descriptor() ([]byte, []int) {
	return fileDescriptor_d8a5dbd3dc2b23d8, []int{0}
}
...
func (*CanonicalPartSetHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_d8a5dbd3dc2b23d8, []int{1}
}
...
func (*CanonicalProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_d8a5dbd3dc2b23d8, []int{2}
}
...
func (*CanonicalVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_d8a5dbd3dc2b23d8, []int{3}
}
...
func init() {
	proto.RegisterType((*CanonicalBlockID)(nil), "celestiacore.types.CanonicalBlockID")
	proto.RegisterType((*CanonicalPartSetHeader)(nil), "celestiacore.types.CanonicalPartSetHeader")
	proto.RegisterType((*CanonicalProposal)(nil), "celestiacore.types.CanonicalProposal")
	proto.RegisterType((*CanonicalVote)(nil), "celestiacore.types.CanonicalVote")
}

func init() {
	proto.RegisterFile("celestiacore/types/canonical.proto", fileDescriptor_d8a5dbd3dc2b23d8)
}

var fileDescriptor_d8a5dbd3dc2b23d8 = []byte{
	// 511 bytes of a gzipped FileDescriptorProto
	,
}
