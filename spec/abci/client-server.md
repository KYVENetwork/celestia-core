...
[protobuf file](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/proto/tendermint/abci/types.proto).
...
- In-process ([Golang](https://github.com/KYVENetwork/tendermint/tree/v0.34.x/abci), [Rust](https://github.com/tendermint/rust-abci))
- ABCI-socket
- GRPC
...
[Go](https://github.com/KYVENetwork/tendermint/tree/v0.34.x/abci/server),
...
our client, see
[here](https://github.com/KYVENetwork/tendermint/tree/v0.34.x/abci/client).
