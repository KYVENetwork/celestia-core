...
[default in-process ABCI client](https://github.com/KYVENetwork/celestia-core/blob/v0.34.4/abci/client/local_client.go#L18)
and the
[default Go ABCI
server](https://github.com/KYVENetwork/celestia-core/blob/v0.34.4/abci/server/socket_server.go#L32)
...
proposal. See [#1861](https://github.com/KYVENetwork/celestia-core/issues/1861).
