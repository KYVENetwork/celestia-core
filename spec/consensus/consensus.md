...
- To _prevote_ or _precommit_ something means to broadcast a prevote
  or precommit [vote](https://github.com/KYVENetwork/tendermint/blob/af3bc47df982e271d4d340a3c5e0d773e440466d/types/vote.go#L50)
  for something.
...
- Nodes gossip to nodes lagging in blockchain height with block
  [commits](https://github.com/KYVENetwork/tendermint/blob/af3bc47df982e271d4d340a3c5e0d773e440466d/types/block.go#L738)
  for older blocks.
...
voting power (see
[implementation](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/types/validator_set.go#L51)).
...
[commit](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/docs/core/validators.md), any 1/3+ coalition of
