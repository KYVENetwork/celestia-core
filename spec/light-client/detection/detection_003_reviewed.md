...
[supervisor]: https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/supervisor/supervisor_001_draft.md
...
[CMBC-SOUND-DISTR-POSS-COMMIT-link]: https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#cmbc-sound-distr-poss-commit1

[LCV-SEQ-SAFE-link]:https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#lcv-seq-safe1

[CMBC-VAL-CONTAINS-CORR-link]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#cmbc-val-contains-corr1

[fetch]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#lcv-func-fetch1

[LCV-INV-TP1-link]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#lcv-inv-tp1

[LCV-LB-link]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#lcv-data-lightblock1

[LCV-LS-link]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#lcv-data-lightstore2

[LVC-HD-link]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#cmbc-header-fields2

[repl]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/supervisor/supervisor_001_draft.md#lc-func-replace-secondary1

[vtt]:
https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_002_draft.md#lcv-func-main2
