...
[Go](https://github.com/KYVENetwork/tendermint/tree/v0.34.x/light).
...
[LCV-DIST-SAFE.1](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/light-client/verification/verification_001_published.md#lcv-dist-safe1) and
