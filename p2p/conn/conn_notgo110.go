...
//
//	https://github.com/KYVENetwork/celestia-core/issues/851
//
// so for go versions < Go1.10 use our custom net.Conn creator
// that doesn't return an `Unimplemented error` for net.Conn.
// Before https://github.com/KYVENetwork/celestia-core/commit/49faa79bdce5663894b3febbf4955fb1d172df04
