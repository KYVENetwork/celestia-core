...
(ABCI)](https://github.com/KYVENetwork/celestia-core/tree/main/abci)
...
Types](https://github.com/KYVENetwork/celestia-core/blob/main/proto/celestiacore/abci/types.proto).
