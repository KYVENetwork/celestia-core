...
```bash
go mod init kvstore
go get github.com/KYVENetwork/celestia-core
go mod edit -replace github.com/KYVENetwork/celestia-core=github.com/cometbft/cometbft@v0.34.28
```
...
file](https://github.com/cometbft/cometbft/blob/v0.34.x/proto/celestiacore/abci/types.proto).
