...
[List of events](https://godoc.org/github.com/KYVENetwork/celestia-core/types#pkg-constants)
...
section](https://github.com/KYVENetwork/celestia-core/blob/v0.34.x/spec/abci/abci++_methods.md#endblock) in
the ABCI spec).
