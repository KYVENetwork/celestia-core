...
definition](https://github.com/KYVENetwork/celestia-core/blob/v0.34.x/types/genesis.go)).
...
- `consensus_params` ([see spec](https://github.com/KYVENetwork/celestia-core/blob/v0.34.x/spec/core/data_structures.md#consensusparams))
    - `block`
...
- `validators`: List of initial validators. Note this may be overridden entirely by the
  ...
  application will initialize the validator set upon `InitChain`.
    ...
    [key type](https://github.com/KYVENetwork/celestia-core/blob/v0.34.x/crypto/ed25519/ed25519.go#L36).
...
> TIP: Find the RPC Documentation [here](https://docs.cometbft.com/v0.34/rpc/)
...
See the
[UPGRADING.md](https://github.com/KYVENetwork/celestia-core/blob/v0.34.x/UPGRADING.md)
