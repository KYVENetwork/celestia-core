...
definition](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/types/genesis.go)).
...
- `consensus_params` ([see spec](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/spec/core/data_structures.md#consensusparams))
    - `block`
...
- `validators`: List of initial validators. Note this may be overridden entirely by the
  ...
  application will initialize the validator set upon `InitChain`.
    ...
    [key type](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/crypto/ed25519/ed25519.go#L36).
...
See the
[UPGRADING.md](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/UPGRADING.md)
