...
See [the IsCaughtUp method](https://github.com/KYVENetwork/tendermint/blob/v0.34.x/blockchain/v0/pool.go#L168).
...
this is an [open issue](https://github.com/KYVENetwork/tendermint/issues/129).
